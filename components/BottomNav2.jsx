...
const BottomNav2 = () => {
    ...
    return (
        <View style={{ position: "absolute", bottom: 2, backgroundColor: "white", width: "100%", paddingVertical: 10, paddingHorizontal: 20, display: "flex", justifyContent: "space-between", alignItems: "center", flexDirection: "row" }}>
            ...
            <MaterialCommunityIcons onPress={()=>router.push("driver/home/wallet")} name="wallet-outline" size={24} color={route.name=="driver/home/wallet" ? "#2666CF":"#8D8C8C"} />
            <AntDesign onPress={()=>router.push("driver/home/profile")} name="user" size={24} color={route.name=="driver/home/profile" ? "#2666CF":"#8D8C8C"} />
