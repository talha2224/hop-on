            ...
            <ScrollView contentContainerStyle={style.Scrollcontainer}>
                ...
                <View style={style.locationContainer}>
                    <View style={[isDarkTheme ? style.locationDark : style.location, { width: "90%" }]}>
                        ...
                        {/* <GooglePlacesAutocomplete placeholder='Where To ?' onPress={(data, details = null) => {console.log(data, details);}}
                            query={{key: 'AIzaSyA0P_pnW6OWas9hZhiEOt0qJ8hSopz_91s',language: 'en',}}
                        /> */}
