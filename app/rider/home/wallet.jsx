        ...
        <View style={style.container}>
            ...
            <ScrollView style={{ paddingHorizontal: 20, }}>
                ...
                <View style={{ marginBottom: 50 }}>
                    {
                        arr.map((i) => (
                            <View key={i} style={{ marginBottom: 10, display: "flex", justifyContent: "space-between", alignItems: "center", flexDirection: "row", backgroundColor: "#F6F6F6", padding: 10, borderRadius: 13 }}>
                                <View style={{ display: "flex", alignItems: "center", flexDirection: "row" }}>
                                    ...
                                    <View style={{ marginLeft: 3 }}>
                                        <Text style={{ color: "#000", marginBottom: 2 }}>Airport to shop </Text>
                                        <Text style={{ color: "#aba8a8" }}>15-03-2023 08:48 am</Text>
                                    </View>
                                </View>

                                <View style={{ marginLeft: 3 }}>
                                    <Text style={{ color: "#000", marginBottom: 2, fontSize: 16, fontWeight: 700 }}>$320</Text>
